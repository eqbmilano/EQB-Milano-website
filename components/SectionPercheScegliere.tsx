...
const cards = [
  ...
  { value: "A piedi", title: "Dal Duomo",   desc: "Piazza Cinque Giornate. Un quartiere vivo, centrale, circondato da una Milano che si muove." },
    ...
    <section id="coworking" ref={sectionRef} className={`section-perche${visible ? " is-visible" : ""}`}>
      <div className="perche__inner">
        ...
        <div className="perche__statement perche-anim perche-anim--5">
          ...
          <a href="/coworking" className="statement__cta">UNISCITI</a>
        </div>
