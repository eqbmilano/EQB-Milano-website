...
const SLIDE_ASSETS = [
  { src: "/assets/01_Terapia_Manuale.jpeg", href: "#terapia-manuale" },
  { src: "/assets/02_Pilates_e_Yoga.jpeg", href: "#pilates-yoga" },
  { src: "/assets/03_Personal_Training.jpeg", href: "#personal-training" },
  { src: "/assets/04_Relax.jpeg", href: "#relax" },
  { src: "/assets/05_Consulenza.jpeg", href: "#consulenza" },
];

type SlideCopy = { label: string; items: string[] };
...
export const SectionInterno: React.FC = () => {
  ...
  const slides = SLIDE_ASSETS.map((asset, i) => ({ ...asset, ...slidesCopy[i] }));
