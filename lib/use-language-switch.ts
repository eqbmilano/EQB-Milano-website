...
/**
 * Logica pura per lo switcher lingua, senza UI: Marco collega qui l'icona/bandierina
 * dove decide (Navbar, menu mobile, footer...). Preserva query string (utm_*, fbclid)
